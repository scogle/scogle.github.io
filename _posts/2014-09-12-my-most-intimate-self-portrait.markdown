...
####The NSA claimed to only collect metadata&mdash;a fact we now know is false&mdash;but even metadata can tell an intimate story.
...
And all of it is captured in a graph.